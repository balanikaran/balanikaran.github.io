...
const Extracurricular = () => {
    ...
    return (
        <div className="extracurricularFragment">
            <div className="extracurricularFragHeading">Extracurricular</div>
            <div className="extracurricularGrid">
                {data.aboutJson.extracurriculars.map(extracurricular => {
                    ...
                    var imageFixed = data.images.edges.find(edge => (
                        edge.node.fixed.originalName === extracurricular.logo
                    ))
                    ...
                    return (
                        <Card key={extracurricular.duration}>
                            <div className="extracurricularCard">
                                ...
                                <Card.Body>
                                    <Card.Title className="extracurricularTitleText">{extracurricular.name}</Card.Title>
                                    <Card.Text className="extracurricularRoleText">{extracurricular.role}</Card.Text>
                                    <Card.Text className="extracurricularDurationText">{extracurricular.duration}</Card.Text>
                                </Card.Body>
                            </div>
                        </Card>
                    )
